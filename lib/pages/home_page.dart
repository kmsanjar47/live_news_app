      ...
      body: Consumer<NewsController>(
        builder: (_, snapshot,___) {
          return SingleChildScrollView(
            child: snapshot.articleList != null?Column(
              children: [
                ...
                ListView.separated(
                  physics: const NeverScrollableScrollPhysics(),
                    shrinkWrap: true,
                    itemBuilder: (context,index){return  NormalNewsCard(categoryList: [const CategoryChip(backgroundColor: Color(0x19F1582C),centerText: "Breaking News",textColor: Color(0xFFF1582C),),
                  SizedBox(width: 2.w,),
                  const CategoryChip(backgroundColor: Color(0x19494949),centerText: snapshot.articleList![index].source!.name!,textColor: Color(0xFF494949),),], imagePath: 'assets/images/2ff8debe6b82ad6b44d242e83f8dac8d.jpg',
            ...
            ):Center(child: Text("Sorry!! No articles found :("),),
          );
        }
      ),
